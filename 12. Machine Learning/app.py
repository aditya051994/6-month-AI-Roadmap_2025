...
model = pickle.load(open(r'C:\DataScience-GenerativeAI-AgenticAI\Practical\DS-GenAi-AgenticAI-Bootcamp\6-month-AI-Roadmap_2025\12. Machine Learning\linear_regression_model.pkl', 'rb'))
